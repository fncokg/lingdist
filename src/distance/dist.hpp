...
namespace lingdist
{
    ...
    DataFrame edit_dist_df(const DataFrame &data, CostTable cost, const String &delim = "", bool squareform = false, bool symmetric = true, bool parallel = false, int n_threads = 2, bool check_missing_cost = true, bool quiet = false);
